const hitungTotalDiskon = (totalBelanja) => {
  if (typeof totalBelanja !== "number")
    return console.log("Inputnya harus number ya");
  ...
  switch (true) {
    case totalBelanja >= 1000000:
      ...
      console.log(
        `Anda mendapatkan diskon 10%, total belanja anda menjadi Rp ${hargaFinal}`
      );
      break;
    case totalBelanja >= 500000 && totalBelanja < 1000000:
      ...
      hargaFinal = totalBelanja - diskon;
      console.log(
        `Anda mendapatkan diskon 5%, total belanja anda menjadi Rp ${hargaFinal}`
      );
      break;
    default:
      hargaFinal = totalBelanja - diskon;
      console.log(
        `Anda tidak mendapatkan diskon, total belanja anda Rp ${hargaFinal}`
      );
  }
};
